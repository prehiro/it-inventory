...
function CatBadge({ cat }: { cat: string }) {
  const style = {
    NCA: "bg-amber-100 text-amber-700 dark:bg-amber-500/15 dark:text-amber-400",
    GENERAL: "bg-purple-100 text-purple-700 dark:bg-purple-500/15 dark:text-purple-400",
    FA: "bg-emerald-100 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-400",
