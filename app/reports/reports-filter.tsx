    ...
    <div className="flex flex-wrap items-end gap-3 rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-800">
      ...
      <div className="ml-auto flex gap-2">
        <button
          disabled={busy !== ""}
          onClick={() => download()}
          className="group relative inline-flex h-[38px] items-center gap-2 overflow-hidden rounded-lg bg-green-700 px-4 text-sm font-semibold text-white shadow-sm transition hover:bg-green-800 active:scale-[0.98] disabled:opacity-60 disabled:hover:bg-green-700"
        >
          <span
            aria-hidden="true"
