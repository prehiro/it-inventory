...
export function TypeIcon({ type, className, neon }: { type: string; className?: string; neon?: string }) {
  ...
  switch (type.toUpperCase()) {
    case "PC":
      return (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={cls} strokeLinecap="round" strokeLinejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" /><line x1="9" y1="22" x2="15" y2="22" /><line x1="12" y1="18" x2="12" y2="20" /><rect x="8" y="6" width="8" height="6" rx="1" /><circle cx="12" cy="15" r="0.5" /></svg>);
    case "LAPTOP":
      return (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={cls} strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="12" rx="2" /><path d="M2 20h20" /><path d="M6 16v-1h12v1" /></svg>);
    case "TABLET":
      return (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={cls} strokeLinecap="round" strokeLinejoin="round"><rect x="5" y="3" width="14" height="18" rx="3" /><path d="M12 18h.01" /></svg>);
    case "KEYBOARD":
      return (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={cls} strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="12" rx="2" /><line x1="6" y1="11" x2="6.01" y2="11" /><line x1="10" y1="11" x2="10.01" y2="11" /><line x1="14" y1="11" x2="14.01" y2="11" /><line x1="18" y1="11" x2="18.01" y2="11" /><line x1="6" y1="15" x2="18" y2="15" /></svg>);
    case "MOUSE":
      return (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={cls} strokeLinecap="round" strokeLinejoin="round"><rect x="7" y="3" width="10" height="18" rx="5" /><line x1="12" y1="6" x2="12" y2="10" /><path d="M12 3a5 5 0 0 0-5 5h10a5 5 0 0 0-5-5z" /></svg>);
    case "PROJECTOR":
      return (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={cls} strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="8" width="20" height="10" rx="2" /><circle cx="9" cy="13" r="2.5" /><line x1="13" y1="13" x2="20" y2="13" /><line x1="6" y1="18" x2="4" y2="22" /><line x1="12" y1="18" x2="12" y2="22" /><line x1="18" y1="18" x2="20" y2="22" /></svg>);
    case "PRINTER":
      return (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={cls} strokeLinecap="round" strokeLinejoin="round"><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2" /><path d="M6 9V3h12v6" /><rect x="6" y="14" width="12" height="8" rx="1" /></svg>);
    case "MONITOR":
      return (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={cls} strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" /><line x1="8" y1="21" x2="16" y2="21" /><line x1="12" y1="17" x2="12" y2="21" /></svg>);
    case "CAMERA":
    case "DIGITAL CAMERA":
      return (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={cls} strokeLinecap="round" strokeLinejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z" /><circle cx="12" cy="13" r="4" /></svg>);
    case "CCTV":
      return (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={cls} strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="5" /><circle cx="12" cy="12" r="2" /><path d="M12 17v5" /><path d="M9 22h6" /><path d="M2 12a10 10 0 0 1 20 0" /><path d="M5 12h-2" /><path d="M21 12h-2" /></svg>);
    case "AC ADAPTOR":
    case "ADAPTOR":
    case "POWER ADAPTOR":
      return (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={cls} strokeLinecap="round" strokeLinejoin="round"><rect x="8" y="2" width="8" height="6" rx="1" /><path d="M12 8v2" /><rect x="6" y="10" width="12" height="12" rx="2" /><line x1="10" y1="14" x2="10" y2="18" /><line x1="14" y1="14" x2="14" y2="18" /></svg>);
    case "KENSINGTON":
      return (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={cls} strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3" /><path d="M12 15v7" /><path d="M9 22h6" /><path d="M12 9V5a4 4 0 0 1 4-4h1" /><path d="M8 7l-3 3" /></svg>);
    default:
      return (<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={cls} strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="3" /><circle cx="12" cy="12" r="3" /></svg>);
  }
}
...
export function ModelSearchBar({
  ...
  return (
    <div className="relative w-full">
      ...
      {value && (
        <button
          onClick={() => { onChange(""); searchRef.current?.focus(); }}
          className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center justify-center rounded-md p-1 text-rose-400 transition hover:bg-rose-50 hover:text-rose-600 dark:hover:bg-rose-500/10 dark:hover:text-rose-400"
